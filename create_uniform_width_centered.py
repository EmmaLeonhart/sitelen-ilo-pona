...
print(f"Creating uniform-width centered syllables:\n")
...
for data in groups_data:
    ...
    # ViewBox: center content horizontally in uniform width
    viewbox_min_x = content_center_x - (UNIFORM_WIDTH / 2)
    viewbox_min_y = actual_min_y
    ...
    print(f"{gid:<20} {UNIFORM_WIDTH:.0f}×{height:.0f}")

print(f"\n✓ Created {len(groups_data)} syllables")
print(f"✓ All {UNIFORM_WIDTH:.0f}px wide, centered")
